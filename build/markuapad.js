...
/***/ function(module, exports, __webpack_require__) {
	...
	var _jsxEditor = __webpack_require__(1);

	var _jsxEditor2 = _interopRequireDefault(_jsxEditor);
	...
	var Markuapad = (function () {
	  function Markuapad() {
	    _classCallCheck(this, Markuapad);

	    console.log("Creating a new instance of the markuapad");
	  }

	  _createClass(Markuapad, [{
	    key: "create",
	    value: function create(elementId) {
	      _react2["default"].render((0, _jsxEditor2["default"])(), document.getElementById(elementId));
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* REACT HOT LOADER */ }).call(this); if (false) { (function () { module.hot.dispose(function (data) { data.makeHot = module.makeHot; }); if (module.exports && module.makeHot) { var makeExportsHot = require("/Users/braden/workspace/markua/markuapad/node_modules/react-hot-loader/makeExportsHot.js"), foundReactClasses = false; if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "editor.jsx" + ": " + err.message); } }); } } })(); }
