...
/***/ function(module, exports, __webpack_require__) {
	...
	if (!(0, _util.getCached)("my-first-markuapad-book/manifest_files")) {
	  ...
	  try {
	    for (var _iterator = INITIAL_FILES[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	...
	var ExampleFileAccessor = (function () {
	  ...
	  _createClass(ExampleFileAccessor, [{
	    ...
	    value: function saveManuscript(files) {
	      ...
	      try {
	        for (var _iterator3 = this.onManuscriptChangeCallbacks[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
	    ...
	    value: function _new(filename) {
	      ...
	      try {
	        for (var _iterator4 = this.onAddCallbacks[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
	    ...
	    value: function _delete(filename) {
	      ...
	      try {
	        for (var _iterator5 = this.onDeleteCallbacks[Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
	    ...
	    key: "onMergeConflicts",
	    value: function onMergeConflicts() {
	      var cb = arguments.length <= 0 || arguments[0] === undefined ? noop : arguments[0];
...
/***/ function(module, exports) {
	...
	var FileAccessor = (function () {
	  ...
	  _createClass(FileAccessor, [{
	    ...
	    key: "onMergeConflicts",
	    value: function onMergeConflicts() {
	      var _fileAccessorDelegate17;

	      return (_fileAccessorDelegate17 = this.fileAccessorDelegate).onMergeConflicts.apply(_fileAccessorDelegate17, arguments);
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _file_accessor = __webpack_require__(241);
